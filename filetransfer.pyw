...
send_button = Button(width=20,text="Send",command = lambda:threading.Thread(target=lambda:send(root,listbox,port_entry,ip_entry)).start())
recv_button = Button(width=20,text="Recieve",command = lambda:threading.Thread(target=lambda:recv(root,listbox,port_entry,ip_entry)).start())
